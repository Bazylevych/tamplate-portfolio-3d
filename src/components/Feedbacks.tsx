...
import { ITestimonials } from "../models/constans";
...
const FeedbackCard: FC<ITestimonials & FeedbackCardProps> = ({
  index,
  testimonial,
  name,
  designation,
  company,
  image,
}: ITestimonials & FeedbackCardProps) => {
  return (
    <motion.div
...
export default function SectionWrappers() {
  return <SectionWrapper Component={Feedbacks} idName="" />;
}
